...
- `AUTONOMOUS_TICKET_SCHEDULER_INTERVAL_MS` to Coordinator repeat interval in milliseconds (default `60000`).
- `AUTONOMOUS_TICKET_SCHEDULER_BATCH_SIZE` to Maximum candidates enqueued per coordinator tick (default `5`).
