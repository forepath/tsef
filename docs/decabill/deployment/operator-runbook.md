...
- [ ] PostgreSQL 16 sized for profile (production small ≥2 to 4 GiB RAM / 50 GiB disk; medium per system requirements)
- [ ] Redis 7 sized for BullMQ history (production ≥1 to 2 GiB); AOF or RDB recovery plan agreed
...
- [ ] API memory limit ≥2 to 4 GiB (PDF path can briefly need **4 GiB**)
...
- [ ] Billing console sized (≥0.5 vCPU, 512 MiB to 1 GiB)
