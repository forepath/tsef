...
- [AI Agents overview](./README.md) `.agenstra` context and Decabill orientation
- [API Reference](../api-reference/README.md) OpenAPI and AsyncAPI contracts
- [Rules](./rules.md) Project instruction files
- [Skills](./skills.md) Reusable skill documents
- [MCP definitions](./mcp-definitions.md) MCP server registration
