...
- **WebSocket gateway**: Dashboard server status on namespace **`billing`**; project board on namespace **`projects`**: **Background jobs**: Billing cycles, expiration, reminders, overdue handling, backorder retry, SSH stack updates
