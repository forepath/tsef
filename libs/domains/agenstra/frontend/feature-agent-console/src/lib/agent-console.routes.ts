...
import {
  ...
  browserPreviewReducer,
  closeBrowserPreviewUiStopsSession$,
  cancelRun$,
  ...
  onBrowserPreviewFrame$,
  onBrowserPreviewSocketError$,
  onBrowserPreviewStarted$,
  onBrowserPreviewStopped$,
  onBrowserPreviewLocation$,
  startBrowserPreview$,
  stopBrowserPreview$,
...
export const agentConsoleRoutes: Route[] = [
  {
    ...
    providers: [
      ...
      provideState('browserPreview', browserPreviewReducer),
