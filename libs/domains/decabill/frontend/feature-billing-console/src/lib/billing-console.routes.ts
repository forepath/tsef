...
import {
  ...
  reloadSubscriptionsSummaryAfterMutation$,
  ...
  archiveAdminOffer$,
  revokeAdminOffer$,
  reloadAdminOfferStatisticsAfterMutation$,
...
import { AdminOffersPageComponent } from './admin-offers-page/admin-offers-page.component';
...
export const billingConsoleRoutes: Route[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: () => buildPageTitle($localize`:@@featureContainer-offersPage:Offers`),
      },
      {
        path: 'invoices',
        canActivate: [authGuard],
      ...
      ...contributorRoutes.customer,
      {
        ...
        children: [
          ...
          },
          {
            path: 'meters',
            canActivate: [authGuard, billingAdminGuard],
            component: MetersPageComponent,
            title: () => buildPageTitle($localize`:@@featureContainer-metersPage:Usage meters`),
          },
          {
            path: 'service-plans',
            canActivate: [authGuard, billingAdminGuard],
          ...
          },
          {
            ...
            title: () => buildPageTitle($localize`:@@featureContainer-adminOffersPage:Offers`),
          },
          {
            path: 'billing',
            canActivate: [authGuard, billingAdminGuard],
          ...
          },
          {
            ...
            canActivate: [authGuard, billingAdminGuard],
            component: AdminSupplierProfilesPageComponent,
            title: () => buildPageTitle($localize`:@@featureContainer-adminSupplierProfilesPage:Supplier Profiles`),
            providers: [
              AdminSupplierProfilesFacade,
    ...
    providers: [
      ...
      provideState('adminSupplierProfiles', adminSupplierProfilesReducer),
      provideState('adminSupplierInvoiceManager', adminSupplierInvoiceManagerReducer),
      provideState('adminSubscriptions', adminSubscriptionsReducer),
      provideState('adminPromotions', adminPromotionsReducer),
      provideState('adminOffers', adminOffersReducer),
      provideState('offers', offersReducer),
